...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.microDopplerView = GraphicsLayoutWidget(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(
            QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred
        )
        self.microDopplerView.setSizePolicy(sizePolicy)
        self.microDopplerView.setMinimumHeight(240)
        self.microDopplerView.setMaximumHeight(420)
        self.microDopplerView.setObjectName("microDopplerView")
        self.verticalLayout_8.addWidget(self.microDopplerView)
        self.verticalLayout_8.addStretch(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "单接收天线微多普勒特征"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "微多普勒"))
